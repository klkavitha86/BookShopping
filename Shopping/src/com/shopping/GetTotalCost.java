 ...
 */
@WebServlet("/GetTotalCost")
public class GetTotalCost extends HttpServlet {
    ...
    String result="";
    System.out.println("From GetTotalCost");
    ...
    if(cart !=null){
		...
		order = (ItemOrder)itemsOrdered.get(i);
         System.out.println("GetTotalCost sku"+order.getCartSku());
         System.out.println("GetTotalCost retail"+order.getCartRetail());
        System.out.println("GetTotalCost qty"+order.getCartQty());
