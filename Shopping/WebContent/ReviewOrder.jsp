...
<a class = "continue" href= "ConfirmOrder"><img  src="Images/Ordernow.jpg" width = "200px" /></a>
<a class = "continue" href= "products.html"><img  src="Images/cancel.jpg" width = "200px" /></a>
...
<tr><td><button class = "change" id="opener">Change Address</button></td><tr>
...
<% if(request.getAttribute("cart_empty")== null){ %>
 ...
 <c:choose>
    ...
    <p>
        ...
        <a class = "remove_cart" href = "#"><img  src = "Images/Delete.jpg" width = "50%" /></a>
        <br />
...
<% } %>
 <div class="error_message" class = "error">
                      <% if(session.getAttribute("sent_error") != null){ %>
                        <%= session.getAttribute("sent_error") %>
                    <% } %>
                </div> 
